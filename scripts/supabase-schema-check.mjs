...
const expectedColumns = [
  ...
  ["br_internal_reports", "report_run_id"],
  ["br_internal_reports", "report"],
...
const expectedIndexes = [
  ...
  "br_internal_reports_created_idx",
  "br_internal_reports_user_idx",
...
const expectedPolicies = [
  ...
  ["br_internal_reports", "internal_reports_no_client_access"],
